...
const AccomplishmentsCard = ({accomplishment,setOpenModal}) => {
    return (
        <Card onClick={() => setOpenModal({state: true, accomplishment: accomplishment})}>
            ...
            <Details>
                ...
                <Button>
                    <a href={accomplishment.certificate} target='display' style={{ textDecoration: 'none' }} >View Profile</a>
                </Button>
            </Details>
            <Members>
                {accomplishment.member?.map((member) => (
